...
function twentytwenty_register_styles() {
	...
	wp_enqueue_style('jquery-ui', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.css', null);
...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script('jquery-validate', 'http://ajax.microsoft.com/ajax/jquery.validate/1.7/jquery.validate.min.js', array(), null, true);	
	wp_enqueue_script('jquery-UI', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js', array(), null, true);
	wp_enqueue_script( 'twentytwenty-js', get_template_directory_uri() . '/assets/js/index.js', array(), null, false );
	wp_enqueue_script( 'autocomplete-js', get_template_directory_uri() . '/assets/js/autocomplete.js', array(), null, false );		

	if(is_front_page()){
		//wp_enqueue_script( 'multistep-search', get_template_directory_uri() . '/assets/js/multistepsearch.js', array(), null, false );
		wp_enqueue_script( 'multistep-search', get_template_directory_uri() . '/assets/js/multistepsearch.js', array(), null, false );
	}else{
		wp_enqueue_script( 'multistep', get_template_directory_uri() . '/assets/js/multistepform.js', array(), null, false );
	}	
...
/**
 * Get Andrea's code working
 *
 * @since Victor & Juanfran were here
 *
 * @return ???
 */
...
add_filter( 'the_content', 'mostrarColectivos' );
add_filter( 'the_content', 'mostrarServicios' );
add_filter( 'the_content', 'mostrarCentros' );
add_filter( 'the_content', 'insertarInformacion' );


function mostrarColectivos() {
	$slug_page = 'colectivos'; //slug de la página donde se mostrará la tabla
    if (is_page($slug_page) || is_front_page()){
	wp_enqueue_script( 'multistep-search', get_template_directory_uri() . '/assets/js/multistepsearch.js', array(), null, false );
        include_once('getColectivo.php');
	}
}

function mostrarServicios() {
	$slug_page = 'servicios'; //slug de la página donde se mostrará la tabla
	//$message = "Entró en mostrarServicios()";
...
function mostrarCentros(){
    $slug_page = 'centros'; //slug de la página donde se mostrará la tabla
    if (is_page($slug_page)){
    wp_enqueue_script( 'multistep-search', get_template_directory_uri() . '/assets/js/multistepsearch.js', array(), null, false );
        //$message = "Entró en mostrarCentros()";
        //echo "<script type='text/javascript'>alert('$message');</script>";
        
        include_once("getCentro.php");
    }   
}

function insertarInformacion(){
    $slug_page = 'insertar-informacion'; //slug de la página donde se insertará información a la BD
    if (is_page($slug_page)){
    wp_enqueue_script( 'multistep-search', get_template_directory_uri() . '/assets/js/multistepsearch.js', array(), null, false );
        //$message = "Entró en mostrarCentros()";
        //echo "<script type='text/javascript'>alert('$message');</script>";
        
        include_once("insertarInformacion.php");
    }   
}
...
function mostrarFrutas() {
	...
	//$table_name = 'tiposervicio'; // nombre de la tabla
